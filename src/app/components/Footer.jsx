...
<footer className=" mt-20 ">
      ...
      <div class="container px-4 mx-auto">
        <div class="-mx-4 flex flex-wrap justify-between">
          ...
          <div class="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            ...
            <a href="https://www.instagram.com/pr.kmit/" class="inline-flex text-black items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-pink-500 transition duration-500 ease-in-out">
    ...
    <div class=" bg-transparent py-4 text-gray-100">
      <div class="container mx-auto px-4">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 w-full font-pixel text-center font-semibold sm:w-auto sm:text-left">
           Designed and Developed by Vardaan Bhatia , Shaik Farhan and Aakash Banda
          </div>
