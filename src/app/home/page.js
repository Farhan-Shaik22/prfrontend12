      ...
      <section>
        <div className="bg-black text-white py-1">
          <div className="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
            ...
            <img src="/NexusLogo.png" alt="TechFest" className="w-[50vh] h-[50vh]" />
            ...
            <div className=" mt-12 mb-6 md:mb-0 md:mt-0 ml-0 md:ml-12 lg:w-2/3 justify-center">
              <div className="h-48 flex flex-wrap content-center">
                <div className=''>
                  {/* <img className="inline-block mt-28 w-64 h-80  xl:block" src="/fin1.png" alt="Image 1" />
                </div>
                <div>
                  <img className="inline-block mt-24  w-64 h-80  md:mt-0 p-0 md:p-0" src="/Fin2.png" alt="Image 2" />
                </div>
                <div>
